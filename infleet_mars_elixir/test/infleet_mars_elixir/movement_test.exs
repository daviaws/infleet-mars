defmodule InfleetMarsElixir.MovementTest do
  ...
  describe "movements_statuses" do
    ...
    test "create_movement_status/1 with valid data creates a movement_status" do
      ...
      assert movement_status.end_direction == 42
      ...
      assert movement_status.start_direction == 42
      ...
      assert movement_status.terminal == 42
    end
    ...
    test "update_movement_status/2 with valid data updates the movement_status" do
      ...
      assert movement_status.end_direction == 43
      ...
      assert movement_status.start_direction == 43
      ...
      assert movement_status.terminal == 43
    end
